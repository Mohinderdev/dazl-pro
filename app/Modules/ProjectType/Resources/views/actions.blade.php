<span>
    {!! Form::open(['method' => 'DELETE', 'route' => ["project-types.destroy", $row->id], 'class' => 'form-horizontal']) !!}
        {!! Form::hidden('id', $row->id) !!}

        <a title="Edit" href="{{ route('project-types.edit', $row->id) }}" class="btn btn-sm btn-clean btn-icon btn-icon-md">
