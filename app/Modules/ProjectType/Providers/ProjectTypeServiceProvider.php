...
namespace App\Modules\ProjectType\Providers;
...
class ProjectTypeServiceProvider extends ServiceProvider
{
    ...
    {
        $this->loadViewsFrom(__DIR__ .'/../Resources/views', 'project-types');
    }
    ...
    {
        $this->loadTranslationsFrom(__DIR__ .'/../Resources/lang', 'project-types');
    }
