...
use App\Modules\Customer\Repositories\ProfessionalApiRepo;
...
class RegisterCustomerFeature extends Feature
{
    protected ProfessionalApiRepo $customerApiRepo;
    /**
     * RegisterUserFeature constructor.
     */
    public function __construct(ProfessionalApiRepo $customerApiRepo)
    {
