<span>
    {!! Form::open(['method' => 'DELETE', 'route' => ["professionals.destroy", $row->id], 'class' => 'form-horizontal']) !!}
        {!! Form::hidden('id', $row->id) !!}

        <a title="Edit" href="{{ route('professionals.edit', $row->id) }}" class="btn btn-sm btn-clean btn-icon btn-icon-md">
