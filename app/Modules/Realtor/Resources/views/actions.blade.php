<span>
    {!! Form::open(['method' => 'DELETE', 'route' => ["realtors.destroy", $row->id], 'class' => 'form-horizontal']) !!}
        {!! Form::hidden('id', $row->id) !!}

        <a title="Edit" href="{{ route('realtors.edit', $row->id) }}" class="btn btn-sm btn-clean btn-icon btn-icon-md">
