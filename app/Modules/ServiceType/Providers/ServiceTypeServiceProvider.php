...
namespace App\Modules\ServiceType\Providers;
...
class ServiceTypeServiceProvider extends ServiceProvider
{
    ...
    {
        $this->loadViewsFrom(__DIR__ .'/../Resources/views', 'service-types');
    }
    ...
    {
        $this->loadTranslationsFrom(__DIR__ .'/../Resources/lang', 'service-types');
    }
