<span>
    {!! Form::open(['method' => 'DELETE', 'route' => ["blog-categories.destroy", $row->id], 'class' => 'form-horizontal']) !!}
        {!! Form::hidden('id', $row->id) !!}

        <a title="Edit" href="{{ route('blog-categories.edit', $row->id) }}" class="btn btn-sm btn-clean btn-icon btn-icon-md">
