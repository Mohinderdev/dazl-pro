...
namespace App\Modules\BlogCategory\Providers;
...
class BlogCategoryServiceProvider extends ServiceProvider
{
    ...
    {
        $this->loadViewsFrom(__DIR__ .'/../Resources/views', 'blog-categories');
    }
    ...
    {
        $this->loadTranslationsFrom(__DIR__ .'/../Resources/lang', 'blog-categories');
    }
